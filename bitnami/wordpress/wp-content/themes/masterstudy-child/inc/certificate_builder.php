...
function custom_certificate_fields($fields) {
    ...
    $fields['duration_info'] = array(
        'name'  => esc_html__( 'Duration', 'masterstudy-lms-learning-management-system-pro' ),
        'value' => esc_html__( '-Duration-', 'masterstudy-lms-learning-management-system-pro' ),
    );
