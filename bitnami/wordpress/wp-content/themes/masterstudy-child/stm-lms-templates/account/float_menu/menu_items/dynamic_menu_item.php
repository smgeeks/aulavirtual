...
<?php if($menu_title == 'Mis cursos') { 
$current_user = wp_get_current_user();
$cusername = $current_user->user_login;

$ccusername = str_replace(' ', '-', $cusername);

$durl = site_url().'/members/'.$ccusername;
?>
<a href="<?php echo esc_url( $durl ); ?>" class="float_menu_item float_menu_item__inline __icon">
	<span class="float_menu_item__title heading_font">
		<?php echo 'Aula Virtual'; ?>
	</span>
	<i class="fa fa-tachometer-alt float_menu_item__icon"></i>
</a>
