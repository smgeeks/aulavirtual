...
(function ($) {
    $(document).ready(function () {
        ...
        $('.stm-lms-single_quiz').submit(function (e) {
            e.preventDefault();
            $('.stm-lms-quiz__result_number p').empty();
            ...
            $.ajax({
                ...
                complete: function complete(data) {
                    ...
                    if(data.user_tries && data.user_tries_msg) {
                        $('.stm-lms-quiz__result_number').prepend(`<p>${data.user_tries_msg}</p>`)
                    }

                    if(data.user_tries === 'unsubscribe') {
                        setTimeout(
                            function(){
