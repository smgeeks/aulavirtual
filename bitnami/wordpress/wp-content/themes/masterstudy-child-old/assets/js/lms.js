...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#course_add_popup .close').click(function () {
            $('#course_add_popup').modal('toggle');
        });
        ...
        $('[data-buy-course]').on('click', function (e) {
            ...
            $.ajax({
                ...
                complete: function complete(data) {
                    ...
                    $('#course_add_popup').modal('toggle')
                    $('#course_add_popup').find('.img').attr('src', data.img_url);
                    $('#course_add_popup').find('.name').html(data.name).attr('href', data.link);
                    $('#course_add_popup').find('.btn').attr('href', data.cart_url);
