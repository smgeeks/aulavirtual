...
<div class="stm-lms-go_pro">
	<section class="stm_go_pro">
		<div class="container">
			...
			<?php if ( $date_now < '2023-07-21' ) { ?>
				<a href="https://stylemixthemes.com/wordpress-lms-plugin/pricing/?plugin_coupon=MS23" target="_blank" class="stm-discount">
					<div class="stm-discount-img">
						<img src="<?php echo esc_url( STM_LMS_URL . '/assets/img/coupon/sale_logo.png' ); ?>">
					</div>
					<img src="<?php echo esc_url( STM_LMS_URL . '/assets/img/coupon/bg_left.svg' ); ?>" class="stm-discount-texture-left">
					<div class="stm-discount-info">
						<div class="stm-discount-info__title">
							<?php esc_html_e( 'Midsummer Sale!', 'masterstudy-lms-learning-management-system' ); ?>
							<span><?php esc_html_e( '30% off', 'masterstudy-lms-learning-management-system' ); ?></span>
							<?php esc_html_e( 'for all plugins', 'masterstudy-lms-learning-management-system' ); ?>
						</div>
						<div class="stm-discount-info__description">
							<img src="<?php echo esc_url( STM_LMS_URL . '/assets/img/coupon/july_logo.svg' ); ?>" class="stm-discount-info__description_img">
							<span><?php esc_html_e( 'July 6-20', 'masterstudy-lms-learning-management-system' ); ?></span>
						</div>
					</div>
					<div class="stm-discount-code">
						<span class="stm-discount-code__label"><?php esc_html_e( 'Coupon code', 'masterstudy-lms-learning-management-system' ); ?></span>
						<span class="stm-discount-code__value"><?php esc_html_e( 'MS23', 'masterstudy-lms-learning-management-system' ); ?></span>
					</div>
					<img src="<?php echo esc_url( STM_LMS_URL . '/assets/img/coupon/bg_right.svg' ); ?>" class="stm-discount-texture-right">
					<img src="<?php echo esc_url( STM_LMS_URL . '/assets/img/coupon/bg_ellipse.svg' ); ?>" class="stm-discount-texture-right-down">
				</a>
			<?php } ?>
