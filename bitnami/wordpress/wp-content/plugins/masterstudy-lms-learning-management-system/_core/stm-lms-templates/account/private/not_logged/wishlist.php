...
if ( ! empty( $_COOKIE['stm_lms_wishlist'] ) ) {
	...
	?>
	<h4><?php printf( wp_kses( 'Favorite Courses will be available after <a href="%s">registration.</a>', 'masterstudy-lms-learning-management-system' ), esc_url( STM_LMS_User::login_page_url() ) ); ?></h4>
<?php } ?>
