...
if ( ! $theme_exists && empty( $start_theme_notice ) ) {
	...
	$init_data['starter-theme'] = array(
		...
		'notice_logo'            => 'ms.svg',
		'notice_title'           => esc_html__( 'What to do next, try the Masterstudy Starter theme.', 'masterstudy-lms-learning-management-system' ),
		'notice_desc'            => '',
		...
		'notice_btn_three_class' => 'starter-skip-btn no-bg',
		'notice_btn_three'       => '#',
...
if ( empty( $buy_pro_notice ) && ! defined( 'STM_LMS_PRO_PATH' ) ) {
	$init_data['lms-unlock-pro-features'] = array(
		...
		'notice_btn_one_class' => 'ms_settings_open',
		'notice_btn_one'       => admin_url( 'admin.php?page=stm-lms-go-pro' ),
