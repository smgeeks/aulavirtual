...
- **FIXED:** The wishlist button on the course card does not work after clearing a field in search
...
- **FIXED:** Course Builder does not work with Gutenberd plugin
...
- **FIXED:** Previous and Next icons are not displayed in Lesson navigation, when lesson Locked with Drip Content,
...
- **FIXED:** Lesson preview displayed error in Trial Course.
...
- **FIXED:** Image Match question type were not working when included in  Question Bank.
