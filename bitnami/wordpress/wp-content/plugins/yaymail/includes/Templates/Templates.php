...
class Templates {
	...
	public static function getList() {
		...
		$listEmails = apply_filters( 'YaymailCreateWcCartAbandonmentRecoveryTemplates', $listEmails );
		$listEmails = apply_filters( 'YaymailCreateB2BMarketTemplates', $listEmails );
