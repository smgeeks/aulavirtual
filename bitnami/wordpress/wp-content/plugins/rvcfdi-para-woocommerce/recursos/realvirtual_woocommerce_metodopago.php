<?php
	class RealVirtualWooCommerceMetodoPago
	{
		static function obtenerCatalogoMetodosPago($rfcEmisor, $usuarioEmisor, $claveEmisor, $urlSistemaAsociado, $idioma)
		{
			global $wp_version;
			
			$opcion = 'ObtenerCatalogoMetodosPago';
