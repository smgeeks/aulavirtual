<?php
	class RealVirtualWooCommerceMetodoPago33
	{
		static function obtenerCatalogoMetodosPago33($rfcEmisor, $usuarioEmisor, $claveEmisor, $urlSistemaAsociado, $idioma)
		{
			global $wp_version;
			
			$opcion = 'ObtenerCatalogoMetodosPago33';
