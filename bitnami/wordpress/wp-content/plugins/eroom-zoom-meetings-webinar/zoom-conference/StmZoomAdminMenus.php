				...
				$fields = array(
					'tab_1'      => array(
						...
						'fields' => array(
							...
							'api_key'               => array(
								'group_title' => esc_html__( 'JWT (JSON WEB TOKEN)  credentials', 'eroom-zoom-meetings-webinar' ),
								'group'       => 'started',
								'type'        => 'text',
								'label'       => esc_html__( 'API key', 'eroom-zoom-meetings-webinar' ),
								'value'       => '',
								'description' => sprintf( '%1s <a href="https://docs.stylemixthemes.com/eroom/getting-started/how-to-obtain-apis#jwt-json-web-token-credentials" target="_blank">%2s</a>  %3s ', esc_html__( 'Please follow this', 'eroom-zoom-meetings-webinar' ), esc_html__( 'guide', 'eroom-zoom-meetings-webinar' ), esc_html__( ' to generate API values from Zoom App Marketplace using your Zoom account.', 'eroom-zoom-meetings-webinar' ) ),
							),
							'api_secret'            => array(
								'type'  => 'text',
								'label' => esc_html__( 'API Secret', 'eroom-zoom-meetings-webinar' ),
								'value' => '',
							),
							'jwt_deprecated_notice' => array(
								'type'         => 'notification_message',
								'description' => sprintf( '<p style="color:#bf5e5e;">%1s <br> %2s <br> %3s </p> ', esc_html__( 'Zoom is deprecating their JWT app from June 1 of 2023.', 'eroom-zoom-meetings-webinar' ), esc_html__( 'We recommend that you create Server-to-Server OAuth', 'eroom-zoom-meetings-webinar' ), esc_html__( ' in easy steps by running the migration wizard.', 'eroom-zoom-meetings-webinar' ) ),
								'group'        => 'ended',
								'buttons'      => array(
									array(
										'text'  => esc_html__( 'Migration Wizard', 'eroom-zoom-meetings-webinar' ),
										'class' => 'eroom-migration-wizard',
									),
								),
								'dependency'   => array(
									array(
