    ...
    !(function (e) {
        ...
        function (t, r, o) {
            ...
            const s = function (e, t = !1) {
                ...
                u = (e) =>
                    Object.entries(e)
                        .map(([e, t]) => c(e) && Object.values(f(e, t)).join(""))
                        .filter(Boolean)
                        .join(" "),
                f = (e, t) => {
                    let r;
        ...
        function (e, t, r) {
            ...
            function s(e, t) {
                for (var r = {}, o = [], n = 0; n < e.length; n++) {
                    ...
                    -1 !== u ? (l[u].references++, l[u].updater(f)) : l.push({ identifier: d, updater: h(f, t), references: 1 }), o.push(d);
                }
                return o;
            }
            function c(e) {
        ...
        function (e, t, r) {
            ...
            e.exports = function (e, t, r) {
                ...
                return (
                    (t = i(t) || 0),
                    o(r) && ((b = !!r.leading), (d = (h = "maxWait" in r) ? l(i(r.maxWait) || 0, t) : d), (g = "trailing" in r ? !!r.trailing : g)),
                    (A.cancel = function () {
            ...
            const k = function (e, t, r) {
                    ...
                    const D = function (t) {
                            (t = g.getData(t)) && t.length
                                ...
                                ? g.addDefaultFields()
                                : e.prepend || e.append || (b.stage.classList.add("empty"), (b.stage.dataset.content = d.a.get("getStarted"))),
                                (() => {
                                    const t = [],
                        ...
                        T = (t) => {
                            const { type: r } = t,
                                ...
                                l = {
                                    ...
                                    inline: () => {
                                        const e = { first: d.a.get("inline"), second: d.a.get("inlineDesc", r.replace("-group", "")) };
                                        return M("inline", t, e);
                                    },
                                    label: () => Q("label", t),
                                    ...
                                    multiple: () => {
                                        const e = {
                                            ...
                                            file: { first: d.a.get("multipleFiles"), second: d.a.get("allowMultipleFiles") },
                                            select: { first: " ", second: d.a.get("selectionsMessage") },
                                        };
                    ...
                    function I(e, t) {
                        ...
                        // START --- CUSTOM SOLID AFFILIATE CODE
                        if (i.requried) {
                            l = {...l, ...{required: true}};
                        }
                        const reqa = '<span class="sld-required-asterisk" style="display:inline"></span>';
                        const a = `<label for="${l.id}">${n[e] || ""}</label>${i.required ? reqa : '' }`;
                        // END --- CUSTOM SOLID AFFILIATE CODE
                    ...
                    function P(e, t) {
                        const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t,
                            ...
                            f = Object.keys(o).map((e) => {
                                const t = { value: e },
                                    r = o[e],
                                    n = Array.isArray(r) ? d.a.get(...r) || r[0] : r;
                                return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), O("option", n, t);
                            }),
                            p = { id: `${e}-${c.lastID}`, title: u.description || i || e.toUpperCase(), name: e, className: `fld-${e} form-control ${a || s || ""}`.trim() };
                        r && (p.multiple = !0);
                    ...
                    const M = (e, t, r = {}) => {
                            const o = (t) => O("label", t, { for: `${e}-${c.lastID}` }).outerHTML,
                                n = { type: "checkbox", className: "fld-" + e, name: e, id: `${e}-${c.lastID}` };
                            t[e] && (n.checked = !0);
                            const i = [];
                        ...
                        z = (e) => {
                            ...
                            return (
                                ...
                                m.d.btn.forEach((r) => {
                                    ...
                                    e === r && o.push("selected");
                                    const n = O("button", d.a.get("styles.btn." + r), { value: r, type: "button", className: o.join(" ") }).outerHTML;
                                    t += n;
                                }),
                                (t += "</div>"),
                        ...
                        U = (e, t) => {
                            const { class: r, className: o, value: n } = t,
                                ...
                                l = d.a.get(e) || e,
                                a = { type: "number", value: i, name: e, placeholder: d.a.get("placeholder." + e), className: `fld-${e} form-control ${r || o || ""}`.trim(), id: `${e}-${c.lastID}` },
                        ...
                        H = (e, t, r) => {
                            const o = r.map((r, o) => {
                                ...
                                i = { id: e + "-" + c.lastID, name: e, className: `fld-${e} form-control` },
                        ...
                        Q = (t, r, o = !1) => {
                            ...
                            let s = "";
                            if (![].some((e) => !0 === e)) {
                                const n = { name: t, placeholder: a, className: `fld-${t} form-control`, id: `${t}-${c.lastID}` },
                                    d = O("label", l, { for: n.id }).outerHTML;
                                ...
                                let f = o ? "none" : "block";
                                "value" === t && (f = r.subtype && "quill" === r.subtype && "none"), (s = O("div", [d, u], { className: `form-group ${t}-wrap`, style: "display: " + f }));
                            }
                            return s.outerHTML;
                        },
                        V = (e) => {
                            const { type: t } = e,
                                r = [];
                            let o = "";
                            return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some((e) => !0 === e) || (o = M("required", e, { first: d.a.get("required") })), o;
                        },
                        W = function (t, i = !0) {
                            ...
                            let u = [
                                O("a", null, { type: "remove", id: "del_" + c.lastID, className: `del-button btn ${w.a}cancel delete-confirm`, title: d.a.get("removeMessage") }),
                                O("a", null, { type: "edit", id: c.lastID + "-edit", className: `toggle-form btn ${w.a}pencil`, title: d.a.get("hide") }),
                                O("a", null, { type: "copy", id: c.lastID + "-copy", className: `copy-button btn ${w.a}copy`, title: d.a.get("copyButtonTooltip") }),
                            ];
                            ...
                            const h = O("div", [T(t), O("a", d.a.get("close"), { className: "close-field" })], { className: "form-elements" }),
                                y = O("div", h, { id: c.lastID + "-holder", className: "frm-holder", dataFieldId: c.lastID });
                            (o.currentEditPanel = y), f.push(y);
                            const v = O("li", f, { class: l + "-field form-field", type: l, id: c.lastID }),
                                x = r(v);
                            x.data("fieldData", { attrs: t }),
                                ...
                                i && (e.editOnAdd && (g.closeAllEdit(), g.toggleEdit(c.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({ behavior: "smooth" }));
                        },
                        Y = function (e, t) {
                            const r = { selected: t ? "checkbox" : "radio" },
                                o = {
                                    ...
                                    string: (e, t) => ["input", null, { value: e, type: "text", placeholder: d.a.get("placeholder." + t) || "" }],
                            ...
                            const n = Object.entries(e).map(([e, t]) => {
                                ...
                                i = { className: `remove btn ${w.a}cancel`, title: d.a.get("removeMessage") };
                    ...
                    q.on(
                        ...
                        q.on("click touchstart", ".remove", (t) => {
                            ...
                            n.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox")
                                ? e.notify.error("Error: " + d.a.get("minOptionMessage"))
                                : l.slideUp("250", () => {
