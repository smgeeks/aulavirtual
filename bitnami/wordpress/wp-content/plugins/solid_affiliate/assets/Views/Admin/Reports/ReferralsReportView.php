...
use SolidAffiliate\Views\Admin\Reports\AdminReportsFiltersView;
   ...
   class ReferralsReportView
   {
     ...
     public static function render($preset_date_range_params, $affiliate_id)
     {
       ...
       $referrals_data = AdminReportsHelper::referrals_data($preset_date_range_params->computed_start_date(), $preset_date_range_params->computed_end_date(), $affiliate_id);
   ...
   ?>
<?php echo AdminReportsFiltersView::render($preset_date_range_params, $affiliate_id) ?>
<!-- Stats -->
