...
use SolidAffiliate\Views\Admin\Reports\AdminReportsFiltersView;
   ...
   class VisitsReportView
   {
     ...
     public static function render($preset_date_range_params, $affiliate_id)
     {
       ...
       $referrals_data = AdminReportsHelper::visits_data($preset_date_range_params->computed_start_date(), $preset_date_range_params->computed_end_date(), $affiliate_id);
