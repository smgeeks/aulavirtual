...
?>
        <div class='sld_chart-container'>
            <div class="sld_chart-container_header">
                <h2><?php _e('Affiliate Orders and Commissions (daily)', 'solid-affiliate') ?></h2>
            </div>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    datasets: [{
                            ...
                            data: <?php echo (json_encode(ChartData::referrals_data('daily', $date_range))) ?>,
                            parsing: {
