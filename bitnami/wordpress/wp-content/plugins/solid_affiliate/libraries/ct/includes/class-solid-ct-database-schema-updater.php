...
if (!class_exists('SOLID_CT_DataBase_Schema_Updater')) :

    class SOLID_CT_DataBase_Schema_Updater
    {

        /**
         * @var SOLID_CT_DataBase Database object
         */
        public $ct_db;

        /**
         * @var SOLID_CT_DataBase_Schema Database Schema object
         */
        public $schema;
                ...
                foreach ($alters as $alter) {
                    ...
                    switch ($alter['action']) {
                        ...
                        case 'ADD INDEX':
                             ...
                             * This means that an nndex which used to have room for floor(767/3) = 255 characters, now only has room for floor(767/4) = 191 characters.
                             */
                            $max_index_length = 191;

                            if (false) { // I just removed this it kept causing errors
                            ...
                            if (self::index_exists($this->ct_db->table_name, $column)) {
