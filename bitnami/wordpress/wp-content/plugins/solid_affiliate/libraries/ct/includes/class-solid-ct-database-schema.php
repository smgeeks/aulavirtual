...
if (!class_exists('SOLID_CT_DataBase_Schema')) :

    class SOLID_CT_DataBase_Schema
    {
        ...
        public function field_array_to_schema($field_id, $field_args)
        {
            ...
            if ($field_args['key']) {
                ...
                if ($this->is_numeric($field_args['type']) || $this->is_datetime($field_args['type'])) {
         ...
         * @return bool
         */
        public function is_datetime($type)
        {
