...
if (!class_exists('SOLID_CT_List_Table')) :

    class SOLID_CT_List_Table extends WP_List_Table
    {
...
?>
        ...
        public function get_views()
        {
            ...
            if (!empty($field_id) && !empty($field_labels) && isset($ct_table->db->schema->fields[$field_id])) {
                ...
                $list_link = solid_ct_get_list_link($ct_table->name);
        ...
        public function get_columns()
        {
             ...
             * @param SOLID_CT_Table $ct_table    The table object.
             */
        ...
        public function column_default($item, $column_name)
        {
             ...
             * @param SOLID_CT_Table  $ct_table    The CT table object.
             */
            ...
            if ($column_name === $columns_keys[$first_column_index] && $can_edit_item) {
                ...
                $value = sprintf(
                    ...
                    solid_ct_get_edit_link($ct_table->name, $item->$primary_key),
        ...
        protected function handle_row_actions($item, $column_name, $primary)
        {
            ...
            if (current_user_can($ct_table->cap->delete_item, $item->$primary_key)) {
                $actions['delete'] = sprintf(
                    ...
                    solid_ct_get_delete_link($ct_table->name, $item->$primary_key),
                    "return confirm('" .
