...
if (!class_exists('SOLID_CT_Edit_View')) :

    class SOLID_CT_Edit_View extends SOLID_CT_View
    {
        ...
        public function init()
        {
            ...
            if (isset($_GET[$primary_key])) {
                ...
                if (empty($this->object_id)) {
                    wp_redirect(solid_ct_get_list_link($ct_table->name));
                    exit();
                }
                ...
                $this->object_id = solid_ct_insert_object(array());
                ...
                $this->object = solid_ct_get_object($this->object_id);
                ...
                wp_redirect(solid_ct_get_edit_link($ct_table->name, $this->object_id));
            }
        }
...
?>
        ...
        public function submit_meta_box($object)
        {
             ...
             * @param SOLID_CT_Table      $ct_table       CT Table object.
             * @param bool          $editing        True if edit screen, false if is adding a new one.
             * @param SOLID_CT_Edit_View  $view           Edit view object.
             */
                ...
                <div id="major-publishing-actions">
                    ...
                    if (current_user_can($ct_table->cap->delete_item, $object_id)) {
                        ...
                        printf(
                            ...
                            solid_ct_get_delete_link($ct_table->name, $object_id),
                            "return confirm('" .
        ...
        public function save()
        {
            ...
            $success = solid_ct_update_object($object_data);
