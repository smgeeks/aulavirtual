 ...
 */
class SOLID_CT_REST_Controller extends WP_REST_Controller
{
    ...
    public function get_items($request)
    {
        ...
        $ct_table = solid_ct_setup_table($this->name);
         ...
         * @param SOLID_CT_Table          $ct_table           Table object.
        ...
        if ($total_items < 1) {
            ...
            $count_query = new SOLID_CT_Query();
    ...
    protected function get_object($id)
    {
        ...
        solid_ct_setup_table($this->name);

        $object = solid_ct_get_object((int) $id);
    ...
    public function create_item($request)
    {
        ...
        $object_id = solid_ct_insert_object(wp_slash((array) $prepared_object), true);
    ...
    public function update_item($request)
    {
        ...
        $object_id = solid_ct_update_object(wp_slash((array) $object), true);
    ...
    public function delete_item($request)
    {
        ...
        if ($force) {
            ...
            $result = solid_ct_delete_object($id, true);
