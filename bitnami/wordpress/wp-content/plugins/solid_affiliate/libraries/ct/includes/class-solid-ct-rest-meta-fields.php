 ...
 */
class SOLID_CT_REST_Meta_Fields extends WP_REST_Meta_Fields
{
    ...
    public function get_value($object_id, $request)
    {
        ...
        foreach ($fields as $meta_key => $args) {
            $name = $args['name'];
            $all_values = solid_ct_get_object_meta($object_id, $meta_key, false);
            if ($args['single']) {
                if (empty($all_values)) {
    ...
    protected function update_meta_value($object_id, $meta_key, $name, $value)
    {
        ...
        if (!solid_ct_update_object_meta($object_id, wp_slash($meta_key), wp_slash($value))) {
            return new WP_Error(
