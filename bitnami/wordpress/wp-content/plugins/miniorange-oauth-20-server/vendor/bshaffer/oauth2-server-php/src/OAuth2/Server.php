...
class Server implements ResourceControllerInterface,
	...
	protected function createDefaultAuthorizeController() {
		...
		if ( $this->config['use_openid_connect'] && isset( $_REQUEST['response_type'] ) && 'token' === $_REQUEST['response_type'] ) {
			$this->responseTypes['token'] = $this->createDefaultIdTokenResponseType();
		}
